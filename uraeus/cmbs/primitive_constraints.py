...
class SphericalConstraint(NamedTuple):
    ...
    def pos_constraint(
        ...
        *args,
        ...
        uP_G = rdt0P_G + transform_vector(pdt0P_G, u_P)
        uS_G = rdt0S_G + transform_vector(pdt0S_G, u_S)
...
class DP1Constraint(NamedTuple):
    ...
    def pos_constraint(
        ...
        *args,
        ...
        residual = transform_vector(pdt0P_G, v1_P) @ transform_vector(pdt0S_G, v2_S)
...
class DP2Constraint(NamedTuple):
    ...
    def pos_constraint(
        ...
        *args,
        ...
        v1_G = transform_vector(pdt0P_G, v1_P)

        dij = (rdt0P_G + transform_vector(pdt0P_G, u_P)) - (
            rdt0S_G + transform_vector(pdt0S_G, u_S)
        )
...
class AngleConstraint(NamedTuple):
    ...
    def pos_constraint(
        ...
        *args,
        ...
        v1_G = transform_vector(pdt0P_G, v1_P)
        v2_G = transform_vector(pdt0S_G, v2_S)
        v3_G = transform_vector(pdt0P_G, v3_P)

        theta = actuation(t)
        c = jnp.cos(theta)
        s = jnp.sin(theta)

        residual = (v3_G @ v2_G) * c - (v1_G @ v2_G) * s
    ...
    def acc_constraint(
        ...
        *args,
        ...
        residual = -(
            (c * v3_G - s * v1_G) @ B(pdt1S_G, v2_S) @ pdt1S_G
            + v2_G.T @ (c * B(pdt1P_G, v3_P) - s * B(pdt1P_G, v1_P)) @ pdt1P_G
            + 2
            * (c * B(pdt0P_G, v3_P) @ pdt1P_G - s * B(pdt0P_G, v1_P) @ pdt1P_G)
